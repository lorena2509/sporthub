        ...
        <tr>
            <td style="padding: 30px;">
                ...
                <p style="font-size: 16px; color: #555;">
                    Te informamos que la siguiente reserva ha sido <strong>cancelada</strong>:
                </p>
                ...
                <p style="font-size: 16px; color: #555; margin-top: 30px;">
                    Si crees que se trata de un error o necesitas más información, por favor contáctanos.
                </p>

                <p style="text-align: center; margin-top: 40px;">
                    <a href="{{ url('/') }}" style="display: inline-block; background-color: #e53935; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px;">Volver al sitio</a>
                </p>
            </td>
        </tr>
        <tr>
